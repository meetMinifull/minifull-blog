...
import com.javaer.myblog.config.Constants;
...
import com.javaer.myblog.util.MyBlogUtils;
...
public class BlogController {
    ...
    private Result List(@RequestParam Map<String, Object> params){
        ...
        if ( params.get("keyword")!=null){
            ...
            pageResult = blogService.getAllByKeyWord(pageNum,pageSize, keyWord);
        }else {
            pageResult = blogService.getAll(pageNum,pageSize);
        }
    ...
    @GetMapping("/blogs/aboutme")
    public String aboutme() {
        List<Blog> about_me = blogService.getBlogByKeyWord("ABOUT ME");
        if(about_me.size()!=0&&about_me.get(0)!=null){
            return "redirect:/admin/blogs/edit/"+about_me.get(0).getBlogId();
        }else {
            return "redirect:/admin/blogs/edit";
        }
    }
